...
//
//struct mcp794xx_time_s default_time_date = {   	        /**< default time and date Tuesday 18/11/2023 14:10:08*/
	//.year    = 23,          							/**< year 2023*/
	//.date    = 18,         	 							/**< date 18th */
	//.hour    = 14,										/**< hour 2pm */
	//.minute  = 10,										/**< minute 10 */
	//.second  = 8,           							/**< seconds 08 */
	//.month   = MCP794XX_MTH_DECEMBER,					/**< month of November */
	//.time_Format = MCP794XX_24HR_FORMAT,                /**< 24hr time format */
	//.weekDay = MCP794XX_WKDAY_TUESDAY,                  /**< week day Tuesday */
